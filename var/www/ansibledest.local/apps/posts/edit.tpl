...
<noscript>
  <div>
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <button type="submit" class="btn-large waves-effect waves-light green">Post<i class="mdi mdi-send right"></i></button>
    </form>
  </div>
  <br />
</noscript>
      ...
      <script type="text/javascript">
        function renderTags() {
          ...
          for(i = 0; i < tags.length; i++) {
            if (/\S/.test(tags[i])) {
              $('#tag-preview').append('<div class="chip green lighten-4">' + tags[i] + '</div>');
            }
          }
        }
...
<div class="yesscript fixed-action-btn" style="bottom: 24px; right: 24px;">
  <a href="#modalpost" class="modal-trigger btn-floating btn-large green tooltipped" data-position="left" data-delay="50" data-tooltip="Post something!">
